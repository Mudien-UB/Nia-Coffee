...
export default function HeroPage() {
    return (
        <section className="w-full min-h-screen bg-gradient-to-br from-amber-50 to-amber-100 flex flex-col justify-center items-center px-4 py-12">
        <div className="max-w-4xl mx-auto text-center space-y-8">
            <div className="animate-fade-in-up delay-200">
            <img
                src="/images/CodeNia.png"
                alt="logo"
                className="relative w-48 h-48 object-contain aspect-square md:w-64 md:h-64 mx-auto transition-transform ease-out duration-300 hover:scale-105"
            />
            </div>
